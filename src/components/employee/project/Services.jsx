  ...
  render() {
    ...
    return (
      <div className={shrink}>
        {popup && <ServiceDetails detail={selection} update={this.beforeUpdate} back={this.back} />}
        ...
        {hover &&
          ...
          <Row>
            ...
            >
              ...
              {
                data && data.map(item => {
                  if((item.projectType === 'Service') && (item.status === 'New')){
                  return <ul
                    key={item.projCode}
            ...
            >
              ...
              {
                data && data.map(item => {
                  if((item.projectType === 'Service') && (item.status === 'WIP')){
                  return <ul
                    key={item.projCode}
                    onClick={() => this.select(item)}
                    draggable
            ...
            >
              ...
              {
                data && data.map(item => {
                  if((item.projectType === 'Service') && (item.status !== 'New')&&(item.status !== 'WIP')){
                  return <ul
                    key={item.projCode}
                    onClick={() => this.select(item)}
                    draggable
                    ...
                    className={`list flex-around pointer ${selected && selected === item.saleId && 'selected-item'}`}
                  >
                    <li className="list-item pad">{item.projName}</li>
                    <li className="list-item pad">{item.location}</li>
                  </ul>
                  }else{
                    return null;
